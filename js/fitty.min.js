      ...
      var r = function(e) {
        ...
        d = function(e) {
          return (
            ...
            (e.dirty === o.DIRTY_LAYOUT && e.element.parentNode.clientWidth !== e.availableWidth)
          );
        },
        p = function(t) {
          var n = e.getComputedStyle(t.element, null);
          (t.currentFontSize = parseInt(n.getPropertyValue("font-size"), 10) - 2),
        ...
        F = { minSize: 10, maxSize: 512, multiLine: !0, observeMutations: "MutationObserver" in e && z },
        g = null,
        D = function() {
